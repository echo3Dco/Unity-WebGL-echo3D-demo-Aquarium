...
namespace GLTFast
{
    ...
    public class GltfBoundsAsset : GltfAsset
    {
        ...
        /// <inheritdoc />
        public override bool InstantiateScene(int sceneIndex, ICodeLogger logger = null, bool zeroTransform = false)
        {
            base.InstantiateScene(sceneIndex, logger, zeroTransform);
