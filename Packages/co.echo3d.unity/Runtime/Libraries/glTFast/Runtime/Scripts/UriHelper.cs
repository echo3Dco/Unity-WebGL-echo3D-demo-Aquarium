...
namespace GLTFast
{
    ...
    static class UriHelper
    {
        ...
        {
            //#echoedit: We always provide an http uri, which is absolute, which here forces
            // a local path uri for some reason, thus returning null and breaking everything
            // downstream.
